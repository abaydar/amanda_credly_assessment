...
class BadgesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create badge" do
    assert_difference('Badge.count') do
      post badges_url, params: { badge: { name: @badge.name, user_id: @badge.user_id } }, as: :json
    end
  ...
  test "should update badge" do
    patch badge_url(@badge), params: { badge: { name: @badge.name, user_id: @badge.user_id } }, as: :json
    assert_response 200
  end
